...
public abstract class Notification implements Comparable<Notification> {
    ...
    public Notification(String recipient, String message, int priority) {
            ...
            if (recipient == null || recipient.trim().isEmpty()) {
                throw new InvalidNotificationException("Recipient is invalid");
            }
            if (message == null) {
                throw new InvalidNotificationException("Message is null");
            }
    ...
    public void send() throws NotDeliverableException {
        if (!isDeliverable()) {
            ...
            throw new NotDeliverableException("Cannot deliver notification");
        }
        performSend();
